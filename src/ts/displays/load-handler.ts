...
import { DecipherSaveCode } from "../utils/decipher-save-code";
...
export class LoadHandler {
    ...
    getGameData(): GameLoadData|null {
        if (this.currentEnteredCode.length < 16) return null;
        return DecipherSaveCode(this.currentEnteredCode.slice());
    }
    /**
