...
const gridDictionary: GridDictionary = {
    ...
    1524: { devDescription: 'Orange Boulder in Green Water - Version 1', gameDescription: 'A massive orange-tinted boulder breaches the surface of the deep green waters', spritePosition: [23, 20], blocker: true },
    1525: { devDescription: 'Orange Boulder in Green Water - Version 2', gameDescription: 'A massive orange-tinted boulder breaches the surface of the deep green waters', spritePosition: [23, 21], blocker: true },
    1526: { devDescription: 'Orange Boulder in Green Water - Version 3', gameDescription: 'A massive orange-tinted boulder breaches the surface of the deep green waters', spritePosition: [23, 22], blocker: true },
    1527: { devDescription: 'Rose Boulder in Green Water - Version 1', gameDescription: 'A massive rose-colored boulder breaches the surface of the deep green waters', spritePosition: [23, 23], blocker: true },
    1528: { devDescription: 'Rose Boulder in Green Water - Version 2', gameDescription: 'A massive rose-colored boulder breaches the surface of the deep green waters', spritePosition: [23, 24], blocker: true },
    1529: { devDescription: 'Rose Boulder in Green Water - Version 3', gameDescription: 'A massive rose-colored boulder breaches the surface of the deep green waters', spritePosition: [22, 24], blocker: true },
