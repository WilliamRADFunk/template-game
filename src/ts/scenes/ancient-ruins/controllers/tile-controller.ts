...
const gridDictionary: GridDictionary = {
    ...
    618: { devDescription: 'Purple Grass (Dirt at sides only) - Version 1', gameDescription: 'Sparse purple grass with dirt framing all of its edges', spritePosition: [10, 18] },
    ...
    718: { devDescription: 'Purple Grass (Sand at sides only) - Version 1', gameDescription: 'Sparse purple grass with sand framing all of its edges', spritePosition: [16, 18] },
    ...
    818: { devDescription: 'Purple Grass (Gravel at sides only) - Version 1', gameDescription: 'Sparse purple grass with gravel framing all of its edges', spritePosition: [22, 18] },
