...
/**
 * @class
 * Button that says Mine.
 */
export class MineButton extends ButtonBase {
    /**
    ...
    /**
     * Constructor for the mine button sub class
    ...
    constructor(position: HTMLElementPosition, colors: ButtonColors, onClick: () => void, visible: boolean, scale?: number) {
        super('mine-button', colors, onClick, visible);

        this._scale = scale || 1;

        this.element.style.borderRadius = '5px';
        this.element.style.fontFamily = 'Luckiest Guy';
        this.element.innerHTML = 'Mine';
