...
/**
 * @class
 * Button with a custom symbol.
 */
export class FreestyleSquareButton extends ButtonBase {
    /**
    ...
    /**
     * Constructor for the freestyle button sub class
     ...
     */
    constructor(position: HTMLElementPosition, colors: ButtonColors, onClick: () => void, visible: boolean, icon: string, scale?: number) {
        index++;
        super(`freestyle-button-${index}`, colors, onClick, visible);
