...
/**
 * @class
 * Button with a right arrow symbol.
 */
export class NextButton extends ButtonBase {
    /**
    ...
    /**
     * Constructor for the next button sub class
    ...
    constructor(position: HTMLElementPosition, colors: ButtonColors, onClick: () => void, visible: boolean, scale?: number) {
        ...
        this.element.classList.add('fa', 'fa-caret-right');
