...
/**
 * @class
 * Button that says Pack It Up.
 */
export class PackItUpButton extends ButtonBase {
    /**
    ...
    /**
     * Constructor for the pack it up button sub class
     ...
     * @param visible whether or not to pack it up the button in a visible state.
    ...
    constructor(position: HTMLElementPosition, colors: ButtonColors, onClick: () => void, visible: boolean, scale?: number) {
        super('pack-it-up-button', colors, onClick, visible);

        this._scale = scale || 1;

        this.element.style.borderRadius = '5px';
        this.element.style.fontFamily = 'Luckiest Guy';
        this.element.innerHTML = 'Pack It Up';
