...
/**
 * @class
 * Button with a left arrow symbol.
 */
export class PreviousButton extends ButtonBase {
    /**
    ...
    /**
     * Constructor for the previous button sub class
    ...
    constructor(position: HTMLElementPosition, colors: ButtonColors, onClick: () => void, visible: boolean, scale?: number) {
        ...
        this.element.classList.add('fa', 'fa-caret-left');
