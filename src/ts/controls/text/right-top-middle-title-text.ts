...
/**
 * @class
 * Text class for text that will appear in the top right middle box, on the box's top.
 */
export class RightTopMiddleTitleText extends TextBase {
    /**
     * Constructor for the right top middle title text sub class
