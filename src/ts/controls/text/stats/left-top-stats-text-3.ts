 ...
 */
export class LeftTopStatsText3 extends TextBase {
    /**
    ...
    constructor(
        ...
        border: string,
        type: TextType) {
        super('left-top-stats-text-3', sentence, color, 'left', border, type);
    ...
    public resize(position: HTMLElementPosition) {
        ...
        this.element.style.top = `${0.05 * position.height}px`;
