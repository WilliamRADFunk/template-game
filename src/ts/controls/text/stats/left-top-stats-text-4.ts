...
/**
 * @class
 * Text class for text that will appear in the top left corner, as the fourth readout.
 */
export class LeftTopStatsText4 extends TextBase {
    /**
    ...
    constructor(
        ...
        border: string,
        type: TextType) {
        super('left-top-stats-text-4', sentence, color, 'left', border, type);
    ...
    public resize(position: HTMLElementPosition) {
        ...
        this.element.style.top = `${0.07 * position.height}px`;
