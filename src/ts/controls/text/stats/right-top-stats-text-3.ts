...
/**
 * @class
 * Text class for text that will appear in the top right corner, as the third readout.
 */
export class RightTopStatsText3 extends TextBase {
    /**
    ...
    constructor(
        ...
        border: string,
        type: TextType) {
        super('right-top-stats-text-3', sentence, color, 'right', border, type);
    ...
    public resize(position: HTMLElementPosition) {
        ...
        this.element.style.left = `${position.left + position.width - (0.26 * position.width)}px`;
