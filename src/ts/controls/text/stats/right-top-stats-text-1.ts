...
/**
 * @class
 * Text class for text that will appear in the top right corner, as the first readout.
 */
export class RightTopStatsText1 extends TextBase {
    /**
    ...
    constructor(
        ...
        border: string,
        type: TextType) {
        super('right-top-stats-text-1', sentence, color, 'right', border, type);
