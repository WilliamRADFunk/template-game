...
/**
 * @class
 * Text class for text that will appear in the top right corner box, on the box's top.
 */
export class RightTopTitleText extends TextBase {
    /**
     * Constructor for the right top title text sub class
     * @param sentence starting text content.
     * @param position height, width, right and top position of the button.
    ...
    constructor(
        ...
        border: string,
        type: TextType) {
        super('right-top-title-text', sentence, color, 'center', border, type);
